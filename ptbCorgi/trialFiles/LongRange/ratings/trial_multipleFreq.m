function [trialData] = trial_multipleFreq(expInfo, conditionInfo)
...
if conditionInfo.nbCycle * cycleDuration > conditionInfo.trialDurationMax
    nbTotalCycle = conditionInfo.nbCycle;
else
    nbTotalCycle = ceil(conditionInfo.trialDurationMax * conditionInfo.stimTagFreq);
end
trialDuration =  nbTotalCycle * cycleDuration;
