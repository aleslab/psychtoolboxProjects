function [trialData] = trial_circle(expInfo, conditionInfo)
...
locLeft = expInfo.center(1) + (conditionInfo.locLeft * expInfo.ppd); 
...
for cycleNb = 1 : nbTotalCycles
    ...
    Screen('FillOval', expInfo.curWindow, black,CenterRectOnPoint(rectStim,locStim+loc1,ycoord));
    if conditionInfo.stim > 1
        Screen('FillOval', expInfo.curWindow, black,CenterRectOnPoint(rectStim,locStim,ycoord));
        Screen('FillOval', expInfo.curWindow, black,CenterRectOnPoint(rectStim,locStim+loc2,ycoord));
        Screen('FillOval', expInfo.curWindow, black,CenterRectOnPoint(rectStim,locStim,ycoord-loc2));
        Screen('FillOval', expInfo.curWindow, black,CenterRectOnPoint(rectStim,locStim+loc1,ycoord-loc2));
        Screen('FillOval', expInfo.curWindow, black,CenterRectOnPoint(rectStim,locStim+loc2,ycoord-loc2));
        Screen('FillOval', expInfo.curWindow, black,CenterRectOnPoint(rectStim,locStim,ycoord+loc2));
        Screen('FillOval', expInfo.curWindow, black,CenterRectOnPoint(rectStim,locStim+loc1,ycoord+loc2));
        Screen('FillOval', expInfo.curWindow, black,CenterRectOnPoint(rectStim,locStim+loc2,ycoord+loc2));
    end
    if conditionInfo.stim > 2
        Screen('FillOval', expInfo.curWindow, black,CenterRectOnPoint(rectStim,locLeft,ycoord));
        Screen('FillOval', expInfo.curWindow, black,CenterRectOnPoint(rectStim,locLeft-loc1,ycoord));
        Screen('FillOval', expInfo.curWindow, black,CenterRectOnPoint(rectStim,locLeft-loc2,ycoord));
        Screen('FillOval', expInfo.curWindow, black,CenterRectOnPoint(rectStim,locLeft,ycoord-loc2));
        Screen('FillOval', expInfo.curWindow, black,CenterRectOnPoint(rectStim,locLeft-loc1,ycoord-loc2));
        Screen('FillOval', expInfo.curWindow, black,CenterRectOnPoint(rectStim,locLeft-loc2,ycoord-loc2));
        Screen('FillOval', expInfo.curWindow, black,CenterRectOnPoint(rectStim,locLeft,ycoord+loc2));
        Screen('FillOval', expInfo.curWindow, black,CenterRectOnPoint(rectStim,locLeft-loc1,ycoord+loc2));
        Screen('FillOval', expInfo.curWindow, black,CenterRectOnPoint(rectStim,locLeft-loc2,ycoord+loc2));
    end
