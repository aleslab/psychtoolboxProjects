function [trialData] = trial_doubleChange(expInfo, conditionInfo)
...
for cycleNb = 1 : nbTotalCycles
    ...
    drawFixation(expInfo, expInfo.fixationInfo);
    if conditionInfo.motion == 1 && mod(cycleNb,2)==0 % in motion
        Screen('FillRect', expInfo.curWindow, white,CenterRectOnPoint(rectStim,eccMotion,ycoord));
        Screen('FillRect', expInfo.curWindow, white,CenterRectOnPoint(rectStim,eccMotion+loc1,ycoord));
        Screen('FillRect', expInfo.curWindow, white,CenterRectOnPoint(rectStim,eccMotion+loc2,ycoord));
        Screen('FillRect', expInfo.curWindow, white,CenterRectOnPoint(horizBar,eccMotion+loc1,yBarTop));
        Screen('FillRect', expInfo.curWindow, white,CenterRectOnPoint(horizBar,eccMotion+loc1,yBarBottom));
    else
        Screen('FillRect', expInfo.curWindow, white,CenterRectOnPoint(rectStim,xcoord,ycoord));
        Screen('FillRect', expInfo.curWindow, white,CenterRectOnPoint(rectStim,xcoord+loc1,ycoord));
        Screen('FillRect', expInfo.curWindow, white,CenterRectOnPoint(rectStim,xcoord+loc2,ycoord));
        Screen('FillRect', expInfo.curWindow, white,CenterRectOnPoint(horizBar,xcoord+loc1,yBarTop));
        Screen('FillRect', expInfo.curWindow, white,CenterRectOnPoint(horizBar,xcoord+loc1,yBarBottom));
    end
