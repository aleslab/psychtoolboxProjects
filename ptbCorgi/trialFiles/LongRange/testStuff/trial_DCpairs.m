function [trialData] = trial_DCpairs(expInfo, conditionInfo)
...
loc = conditionInfo.loc * expInfo.ppd;
...
for cycleNb = 1 : nbTotalCycles
    ...
    %%% stim ON
    drawFixation(expInfo, expInfo.fixationInfo);
    if mod(cycleNb,2)==0 % in motion
        Screen('FillRect', expInfo.curWindow, black,CenterRectOnPoint(rectStim,xcoord,ycoord));
        Screen('FillRect', expInfo.curWindow, white,CenterRectOnPoint(rectStim,xcoord+loc,ycoord));
        Screen('FillRect', expInfo.curWindow, black,CenterRectOnPoint(rectStim,xcoord+loc+loc,ycoord));
        Screen('FillRect', expInfo.curWindow, white,CenterRectOnPoint(rectStim,xcoord+loc+loc+loc,ycoord));
        Screen('FillRect', expInfo.curWindow, black,CenterRectOnPoint(rectStim,xcoord+loc+loc+loc+loc,ycoord));
        Screen('FillRect', expInfo.curWindow, white,CenterRectOnPoint(rectStim,xcoord+loc+loc+loc+loc+loc,ycoord));
    else
        Screen('FillRect', expInfo.curWindow, white,CenterRectOnPoint(rectStim,xcoord,ycoord));
        Screen('FillRect', expInfo.curWindow, black,CenterRectOnPoint(rectStim,xcoord+loc,ycoord));
        Screen('FillRect', expInfo.curWindow, white,CenterRectOnPoint(rectStim,xcoord+loc+loc,ycoord));
        Screen('FillRect', expInfo.curWindow, black,CenterRectOnPoint(rectStim,xcoord+loc+loc+loc,ycoord));
        Screen('FillRect', expInfo.curWindow, white,CenterRectOnPoint(rectStim,xcoord+loc+loc+loc+loc,ycoord));
        Screen('FillRect', expInfo.curWindow, black,CenterRectOnPoint(rectStim,xcoord+loc+loc+loc+loc+loc,ycoord));
    end
    prevStim = t;
