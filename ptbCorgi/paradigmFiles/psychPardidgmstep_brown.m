function [conditionInfo,expInfo] = psychPardidgmstep_brown(expInfo)

expInfo.paradigmName = 'brownStep';
...
conditionInfo(1).nReps             = 40; %% number of trials to present this condition. 
