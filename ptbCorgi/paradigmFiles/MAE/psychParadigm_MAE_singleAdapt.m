function [conditionInfo, expInfo] = psychParadigm_MAE_singleAdapt(expInfo)
...
conditionInfo(1).trialFun=@trial_MAE_singleAdapt;
...
% selective response
standardDirection = [0 180 99]; % of standard 0=left, 180=right, 99=single grating
