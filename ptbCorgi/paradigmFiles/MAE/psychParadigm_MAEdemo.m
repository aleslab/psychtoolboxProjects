...
conditionInfo(1).testDuration = 10; % in cycles. 5 seconds = 20/85*20 cycles (exactly 4.7 seconds)
conditionInfo(1).adaptDuration = 5; % in sec: 10s top-up
conditionInfo(1).longAdapt = 5; % 20 sec added to top-up for the 1st trial
