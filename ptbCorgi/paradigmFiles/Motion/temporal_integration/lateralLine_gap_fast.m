function [conditionInfo, expInfo] = lateralLine_gap_fast(expInfo)

%paradigm for exp 4 (temporal integration experiment).

expInfo.paradigmName = 'lateralLine_gap_fast';
