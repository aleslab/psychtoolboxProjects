function [conditionInfo, expInfo] = lateralLine_flipped_gap_fast(expInfo)

%paradigm for exp 8 (temporal integration experiment control). Flipped
%lengths of intervals 

expInfo.paradigmName = 'lateralLine_flipped_gap_fast';
