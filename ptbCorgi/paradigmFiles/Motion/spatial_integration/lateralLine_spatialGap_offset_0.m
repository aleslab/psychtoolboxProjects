function [conditionInfo, expInfo] = lateralLine_spatialGap_offset_0(expInfo)

%paradigm for exp 5 (spatial integration experiment).

expInfo.paradigmName = 'lateralLine_spatialGap_offset_0';
...
%for iGap = 1:length(spatialGap);
    ...
    for iSpeed = 1: length(section2velocity);
        ...
        conditionInfo(iCond).spatialGap = 0;
