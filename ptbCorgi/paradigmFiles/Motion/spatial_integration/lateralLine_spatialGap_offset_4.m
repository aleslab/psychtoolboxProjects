function [conditionInfo, expInfo] = lateralLine_spatialGap_offset_4(expInfo)

%paradigm for exp 6 (spatial integration experiment).

expInfo.paradigmName = 'lateralLine_spatialGap_offset_4';
...
%for iGap = 1:length(spatialGap);
    ...
    for iSpeed = 1: length(section2velocity);
        ...
        conditionInfo(iCond).spatialGap = 4;
