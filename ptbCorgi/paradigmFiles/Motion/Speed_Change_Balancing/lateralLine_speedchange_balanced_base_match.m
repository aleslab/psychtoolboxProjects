function [conditionInfo, expInfo] = lateralLine_speedchange_balanced_base_match(expInfo)
...
expInfo.paradigmName = 'lateralLine_speedchange_balanced_base_match';
...
%velocities
section1velocity = [10 9 8 7 6 5 4]; %velocities to use in deg/s;
