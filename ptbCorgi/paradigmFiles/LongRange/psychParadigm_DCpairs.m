function [conditionInfo, expInfo] = psychParadigm_DCpairs(expInfo)
...
conditionInfo(1).trialFun=@trial_DCpairs;
conditionInfo(1).trialDuration = 24*32/85; % 6*32/85; % in sec 
...
conditionInfo(1).loc = 1; % xlocation of the 2nd stimulus IN ADDITION to the first stimulus
