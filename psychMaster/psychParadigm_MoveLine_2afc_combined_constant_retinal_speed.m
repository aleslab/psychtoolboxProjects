function [conditionInfo, expInfo] = psychParadigm_MoveLine_2afc_combined_constant_retinal_speed(expInfo)
...
expInfo.paradigmName = 'MoveLine_combined_constant_retinal_speed';
