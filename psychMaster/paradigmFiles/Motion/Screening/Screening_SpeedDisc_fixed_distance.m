function [conditionInfo, expInfo] = Screening_SpeedDisc_fixed_distance(expInfo)
...
expInfo.paradigmName = 'Screening_SpeedDisc_fixed_distance';
...
conditionInfo(iCond).horizontalOneStartPos = 1; %a y coordinate.
